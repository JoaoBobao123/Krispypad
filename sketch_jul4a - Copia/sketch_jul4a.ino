...
byte mac[] = { A4, 63, A1, 70, 92, BC}; //ATRIBUIÇÃO DE ENDEREÇO MAC AO ETHERNET SHIELD W5100
byte ip[] = { 192, 168, 60, 101}; //COLOCAR UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR. 
byte gateway[] = {192, 168, 60, 117}; //GATEWAY DE CONEXÃO (ALTERE PARA O GATEWAY DO SEU ROTEADOR)
